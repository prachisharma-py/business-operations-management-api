...
@pytest.mark.django_db
def test_employee_cannot_create_department(user):
    permission = DepartmentManagerPermission()
...
@pytest.mark.django_db
def test_manager_can_modify_own_department(manager_user):
...
@pytest.mark.django_db
def test_manager_cannot_modify_another_managers_department(
    manager_user,
    admin_user,
):
    manager_employee = Employee.objects.create(
    ...
    other_manager_employee = Employee.objects.create(
        user=admin_user,
        employee_id="MGR002",
        department="Finance",
    ...
    department = Department.objects.create(
        ...
        manager=other_manager_employee,
    )
